    ...
    specs.forEach(function(spec){
      if( spec.tag  === 'rect' ){
        if( spec.props.type === 'fill'){
          ...
          ctx.fillRect(spec.props.x, spec.props.y, spec.props.rx, spec.props.ry);
        } else if( spec.props.type === 'stroke'){
          if( spec.props.color ){
            ctx.strokeStyle = spec.props.color;
          }
          ctx.strokeRect(spec.props.x, spec.props.y, spec.props.rx, spec.props.ry);
        } else if( spec.props.type === 'clear'){
          ctx.clearRect(spec.props.x, spec.props.y, spec.props.rx, spec.props.ry);
        }
      }
    });
  }
